...
from OpenGL_Rotation import PyQtOpenGL
from Networking_TCPServer_TCPClient import TcpServer, TcpClient
...
class MainWindow_EXEC():
    ...
    def sql_tableview_model(self):
        ...
        self.model.setEditStrategy(
            QtSql.QSqlTableModel.OnFieldChange)  # All changes to the model will be applied immediately to the database
        self.model.select()
